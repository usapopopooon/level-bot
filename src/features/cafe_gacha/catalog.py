...
if len(CARDS) != 433:
    raise RuntimeError("cafe gacha catalog must contain exactly 433 cards")
if len(CARDS_BY_KEY) != len(CARDS):
    raise RuntimeError("cafe gacha card keys must be unique")
if len(FOOD_CARD_KEYS) != 162 or not CARDS_BY_KEY.keys() >= FOOD_CARD_KEYS:
    raise RuntimeError("cafe gacha catalog must contain exactly 162 food cards")
