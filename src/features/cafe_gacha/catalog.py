...
CARDS: tuple[CafeCard, ...] = (
    ...
    # 日本ローカル喫茶めぐり: 郷土のおやつ・軽食30種と地域ドリンク30種
    _card(
        "hokkaido-imomochi",
        "いももち",
        "C",
        260,
        "蒸してつぶしたじゃがいもをでんぷんでまとめ、丸く焼く北国のおやつ。",
    ),
    _card(
        "aomori-gapparamochi",
        "がっぱらもち",
        "C",
        260,
        "ごはんと小麦粉に黒砂糖とごまを混ぜ、フライパンいっぱいに焼く津軽の味。",
    ),
    _card(
        "iwate-ganzuki",
        "がんづき",
        "C",
        260,
        "黒砂糖の生地をごまやくるみと蒸し上げた、もっちり素朴な小昼食。",
    ),
    _card(
        "miyagi-zunda-mochi",
        "ずんだ餅",
        "UC",
        96,
        "つぶした枝豆を鮮やかな緑のあんにして、やわらかな餅へたっぷり。",
    ),
    _card(
        "akita-butter-mochi",
        "バター餅",
        "UC",
        96,
        "餅へバターや砂糖を練り込み、時間がたってもやわらかく仕上げる。",
    ),
    _card(
    ...
    _card(
        ...
        "C",
        260,
        "蒸したさつまいもを干して、自然な甘みをぎゅっと濃くした平たいおやつ。",
    ),
    _card(
        "tochigi-imo-fry",
        "いもフライ",
        "C",
        260,
        "蒸したじゃがいもへ衣をつけて串揚げにし、甘辛いソースをまとわせる。",
    ),
    _card(
        "gunma-yaki-manju",
        "焼きまんじゅう",
        "UC",
        96,
        "ふかふかのまんじゅうを串に刺し、甘い味噌だれを塗って香ばしく焼く。",
    ),
    _card(
        "saitama-miso-potato",
        "みそポテト",
    ...
    _card(
        ...
        "C",
        260,
        "炒った落花生を甘味噌でつやよく絡めた、ごはんにもお茶にも合う常備菜。",
    ),
    _card(
        "yokohama-sanma-men",
        "サンマーメン",
        "R",
        32,
        "温かな麺の上へ、しゃきしゃき野菜のとろみあんをたっぷり重ねる。",
    ),
    _card(
        "niigata-poppo-yaki",
        "ぽっぽ焼き",
        "C",
        260,
        "黒砂糖の生地を細長く焼いた、祭りの湯気と一緒に頬張る素朴な菓子。",
    ),
    _card(
        ...
        "UC",
        96,
        "海苔の代わりにふわりとしたとろろ昆布をまとわせる、富山の日常おにぎり。",
    ),
    _card(
        ...
        "UC",
        96,
        "黒砂糖の風味をきかせた薄くやわらかな水ようかんを、こたつの季節に。",
    ),
    _card(
        "nagano-milk-bread",
        "牛乳パン",
        "C",
        260,
        "厚いふわふわパンへ白いミルククリームを挟んだ、山国育ちの菓子パン。",
    ),
    _card(
        "gifu-gohei-mochi",
        "五平餅",
        "UC",
        96,
        "つぶしたごはんを串につけ、くるみやごまの甘味噌だれで香ばしく焼く。",
    ),
    _card(
        "aichi-oni-manju",
        "鬼まんじゅう",
    ...
    _card(
        ...
        "C",
        260,
        "あん入りの餅を丸いサルトリイバラの葉で包み、香りよく蒸し上げる。",
    ),
    _card(
        "shiga-decchi-yokan",
        "丁稚羊羹",
    ...
    _card(
        ...
        "C",
        260,
        "薄いえびせんべいで熱々のたこ焼きを挟み、ソースをきゅっと受け止める。",
    ),
    _card(
        "nara-shikishiki",
        "しきしき",
        "C",
        260,
        "小麦粉に水と砂糖を混ぜて薄く焼く、戦前から伝わる素朴なおやつ。",
    ),
    _card(
        "tottori-imo-bota",
        "いもぼた",
        "UC",
        96,
        "さつまいもと米を一緒につき、きな粉や小豆を添える砂丘の里のぼた餅。",
    ),
    _card(
        "shimane-aka-ten",
        "赤てん",
    ...
    _card(
        ...
        "R",
        32,
        "えび入りのごはんを濃い色の香ばしいソースで炒め、錦糸卵を添える。",
    ),
    _card(
        "hiroshima-gansu",
        "がんす",
    ...
    _card(
        ...
        "UC",
        96,
        "小豆あんを薄い餅生地で包み、梅の印をつけて香ばしく焼き上げる。",
    ),
    _card(
        ...
        "R",
        32,
        "厚切りさつまいもと小豆あんを小麦の生地で包み、ほかほかに蒸す。",
    ),
    _card(
        "oita-yaseuma",
        "やせうま",
        "R",
        32,
        "平たくのばしてゆでた小麦の生地へ、きな粉と砂糖をたっぷりまぶす。",
    ),
    _card(
        "okinawa-chinbin",
        "ちんびん",
        "C",
        260,
        "黒糖を混ぜた薄い生地をくるくる巻いた、やさしく甘い沖縄の焼き菓子。",
    ),
    _card(
    ...
    _card(
        ...
        "C",
        260,
        "山形で長く親しまれる、淡い黄色と甘い香りのパイン風味サイダー。",
    ),
    _card(
    ...
    _card(
        ...
        "C",
        260,
        "やさしい乳の甘さにレモンの香りを重ねた、淡い黄色のご当地定番。",
    ),
    _card(
    ...
    _card(
        ...
        "C",
        260,
        "ゆずの鮮烈な香りを蜂蜜の甘さで整えた、山里生まれの爽やかな一杯。",
    ),
    _card(
        ...
        "UC",
        96,
        "赤いいちごをつぶしてミルクと合わせた、果肉入りの春色ドリンク。",
    ),
    _card(
        "nagasaki-sonogi-tea",
        "そのぎ玉緑茶",
    ...
    _card(
        ...
        "C",
        260,
        "かぼすのすっきりした酸味と香りを、細かな泡の炭酸で弾けさせる。",
    ),
    _card(
        ...
        "UC",
        96,
        "白い皮ごと楽しめる柑橘の香りを、淡い黄色のソーダに閉じ込める。",
    ),
    _card(
        ...
        "R",
        32,
        "南の島の黒糖をミルクへ溶かし、深いこくとやさしい甘さを重ねる。",
    ),
    _card(
        ...
        "C",
        260,
        "小さな緑の柑橘を搾り、南国らしい強い酸味をきりっと冷やす。",
    ),
    # 欧米カフェの定番: 既存カードと料理・飲み物が重ならない30種
    _card(
        "lemonade",
        "レモネード",
        "C",
        260,
        "レモン果汁を水と砂糖で整え、氷を浮かべた甘酸っぱい定番。",
    ),
    _card(
        "orange-juice",
        "オレンジジュース",
    ...
    _card(
        ...
        "UC",
        96,
        "濃いエスプレッソへ、染みのように少量のミルクフォームを添える。",
    ),
    _card(
        "cortado",
        "コルタード",
        "UC",
        96,
        "エスプレッソを同量ほどの温かなミルクで切り、力強さをなめらかに。",
    ),
    _card(
        "london-fog",
        "ロンドンフォグ",
        "UC",
        96,
        "アールグレイへ温かなミルクとバニラを合わせた、霧色のティーラテ。",
    ),
    _card(
        "root-beer-float",
        "ルートビアフロート",
    ...
    _card(
        ...
        "R",
        32,
        "熱い珈琲にアイリッシュウイスキーと砂糖を合わせ、クリームを浮かべる。",
    ),
    _card(
        "croissant",
        "クロワッサン",
        "C",
        260,
        "幾層ものバター生地を三日月形に焼いた、外はさくり中はしっとりのパン。",
    ),
    _card(
        "cream-cheese-bagel",
        "クリームチーズベーグル",
        "C",
        260,
        "むっちりしたベーグルを割り、なめらかなクリームチーズをたっぷり。",
    ),
    _card(
        "blueberry-muffin",
        "ブルーベリーマフィン",
    ...
    _card(
        ...
        "C",
        260,
        "オーツ麦をミルクでやわらかく煮て、果物とナッツを添える朝の一椀。",
    ),
    _card(
        "tomato-soup",
        "トマトスープ",
    ...
    _card(
        ...
        "UC",
        96,
        "折り重ねたバター生地で棒状のチョコレートを包み、さくりと焼く。",
    ),
    _card(
        "avocado-toast",
        "アボカドトースト",
        "UC",
        96,
        "香ばしいパンへつぶしたアボカドを広げ、レモンと胡椒をきかせる。",
    ),
    _card(
        "carrot-cake",
        "キャロットケーキ",
        "UC",
        96,
        "にんじんとスパイスの生地へ、白いクリームチーズフロスティングを重ねる。",
    ),
    _card(
        "affogato",
        "アフォガート",
        "UC",
        96,
        "冷たいバニラジェラートへ熱いエスプレッソを注ぎ、溶け際を味わう。",
    ),
    _card(
        "tuna-melt",
        "ツナメルト",
        "UC",
        96,
        "ツナフィリングとチーズをパンに挟み、表面を香ばしく焼き上げる。",
    ),
    _card(
        "reuben-sandwich",
        "ルーベンサンドイッチ",
    ...
    _card(
        ...
        "UC",
        96,
        "ベーコン入りの卵とクリームをパイ台へ流し、香ばしく焼き固める。",
    ),
    _card(
        "eggs-benedict",
        "エッグベネディクト",
        "UC",
        96,
        "マフィンにハムとポーチドエッグを重ね、オランデーズソースをかける。",
    ),
    _card(
        "cheese-omelet",
        "チーズオムレツ",
    ...
    # N〜R: 縄文・弥生・古墳をたどる列島古代風メニュー（3種）
    _card(
        "jomon-pottery-nut-soup",
        "縄文土器の木の実スープ",
        "C",
        1,
        "縄目を刻んだ深鉢で、どんぐりと栗、山菜をことこと。列島の森を煮込んだ一杯。",
    ),
    _card(
        ...
        "UC",
        1,
        "薄手の甕で赤米をやわらかく炊き、稲穂の実りをとろりと味わう朝粥。",
    ),
    _card(
    ...
    # N: 大航海時代の船倉を支えた日常の保存食と飲み物（5種）
    _card(
        "under-soaked-salt-beef",
        "塩抜きが足りない塩漬け牛肉",
        "C",
        1,
        "樽から出して水で戻し、茹でてもまだ塩辛い。長い航海を支えた保存肉。",
    ),
    _card(
    ...
    _card(
        ...
        "C",
        1,
        "干して硬くした鱈を水で戻し、塩気ごと煮る。船倉で長く持つ魚の保存食。",
    ),
    _card(
        ...
        "C",
        1,
        "長旅に耐える硬いチーズ。航海が延びるほど、ナイフの出番が増えていく。",
    ),
    _card(
        "barrel-bottom-ale",
        "樽の底のぬるいエール",
