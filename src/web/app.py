...
from src.features.marimo_xp.routes import router as marimo_xp_router
...
from src.features.minecraft_woodcutting.routes import (
    router as minecraft_woodcutting_router,
)
...
def _is_marimo_api_path(path: str) -> bool:
