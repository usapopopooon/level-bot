...
価格曲線は勝ちやすさを残しつつ損失も現実的に起こるようにし、決定的サンプル上で
次の相場更新で赤字になる率を20〜24%、期限売却で赤字になる率を26〜30%に保つ。
翌日売却と期限売却の黒字率は70%以上、7日間のうち一度でも黒字になる率は97%以上、
最良日の平均利益は1袋45〜90 XPとし、必ず利益になる仕様にはしない。
